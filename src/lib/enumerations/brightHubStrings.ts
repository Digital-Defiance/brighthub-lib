...
export const BrightHubStrings = createI18nStringKeys(BrightHubComponentId, {
  ...
  PostComposer_VisibilityPublic: 'PostComposer_VisibilityPublic',
  PostComposer_VisibilityFollowersOnly: 'PostComposer_VisibilityFollowersOnly',
  PostComposer_VisibilityFriendsOnly: 'PostComposer_VisibilityFriendsOnly',
  PostComposer_VisibilityHubOnly: 'PostComposer_VisibilityHubOnly',
  ...
  UserProfileCard_Friends: 'UserProfileCard_Friends',
  UserProfileCard_FriendsTab: 'UserProfileCard_FriendsTab',
  UserProfileCard_FriendsHidden: 'UserProfileCard_FriendsHidden',
  ...
  ConnectionSuggestions_ReasonSimilarToUser:
    'ConnectionSuggestions_ReasonSimilarToUser',
  ConnectionSuggestions_ReasonMutualFriends:
    'ConnectionSuggestions_ReasonMutualFriends',
  ...
  ConnectionPrivacySettings_ShowReadReceipts:
    'ConnectionPrivacySettings_ShowReadReceipts',
  ConnectionPrivacySettings_HideFriendsFromNonFriends:
    'ConnectionPrivacySettings_HideFriendsFromNonFriends',
