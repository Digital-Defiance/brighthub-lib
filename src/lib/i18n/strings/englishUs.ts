...
export const BrightHubAmericanEnglishStrings: ComponentStrings<BrightHubStringKey> =
  {
    ...
    [BrightHubStrings.PostComposer_VisibilityFollowersOnly]: 'Followers Only',
    [BrightHubStrings.PostComposer_VisibilityFriendsOnly]: 'Friends Only',
    [BrightHubStrings.PostComposer_VisibilityHubOnly]: 'Hub Members Only',
    ...
    [BrightHubStrings.UserProfileCard_Friends]: 'Friends',
    [BrightHubStrings.UserProfileCard_FriendsTab]: 'Friends',
    ...
    [BrightHubStrings.ConnectionPrivacySettings_HideFriendsFromNonFriends]:
      'Hide friends list from non-friends',
